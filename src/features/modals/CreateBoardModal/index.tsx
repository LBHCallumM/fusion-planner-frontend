...
const CreateBoardModal = ({ modalVisible, handleClose, handleAddBoard }: Props) => {
    ...
    return (
        <Modal modalVisible={modalVisible} handleClose={handleClose}>
            <div className="sm:p-2 md:p-4 lg:p-8">
                ...
                <h2 className="text-2xl text-gray-800 mb flex items-center font-medium">Create modal</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="bg-gray-600 text-white py-2 px-4 rounded-sm mt-4">Create modal</button>
                </form>
